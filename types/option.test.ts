    ...
    await t.step("and", async (t) => {
        await t.step(
            ...
            () => {
                ...
                const result =
                    Option.and(Option.Some(value), Option.Some(otherValue));
        ...
        await t.step(
            ...
            () => {
                const value = "Hello";
                const result =
                    Option.and(Option.Some(value), Option.None());
        ...
        await t.step(
            ...
            () => {
                ...
                const result =
                    Option.and(Option.None(), Option.Some(otherValue));
        ...
        await t.step(
            ...
            () => {
                const result =
                    Option.and(Option.None(), Option.None());
