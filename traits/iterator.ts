...
export type IteratorItem<I extends Iterator<unknown>> =
...
type IsSameItem<T, I extends Iterator<T>> =
    T extends IteratorItem<I>
        ? true
        : IteratorItem<I> extends T
        ? true
        : never;

export namespace Iterator {
    export function isIterator(maybeIterator: unknown)
    ...
    export function next<I extends Iterator<any>>(iterator: I)
    : Option<IteratorItem<I>> {
        return iterator[IteratorSymbol].next();
    }

    export function map
    <I extends Iterator<any>, F extends (args: IteratorItem<I>) => any>
    (iterator: I, fn: F)
    : Map<Iterator<IteratorItem<I>>, F> {
